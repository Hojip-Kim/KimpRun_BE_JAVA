...
public class BithumbMarketListProviderTest {
    ...
    @InjectMocks
    private BithumbMarketListProvider bithumbMarketListProvider;

    private List<String> mockMarketList;
    private String bithumbApiUrl = "https://api.bithumb.com/v1/market/all";
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(bithumbMarketListProvider, "bithumbApiUrl", bithumbApiUrl);
    }
    ...
    void shouldReturnMarketListWithTicker() throws IOException {
        ...
        when(marketCommonMethod.getMarketListByURLAndStartWith(
                ...
                eq("KRW-"), 
                eq("getMarket"), 
                eq(BithumbMarketNameData[].class)))
            .thenReturn(mockMarketList);

        // Act
        List<String> result = bithumbMarketListProvider.getMarketListWithTicker();
    ...
    void shouldReturnMarketListWithoutTicker() throws IOException {
        ...
        // Act
        List<String> result = bithumbMarketListProvider.getMarketList();
